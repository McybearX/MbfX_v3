...
def menu():
	...
	emil_lope_usup(u+" ["+m+"07"+u+"]"+p+" Crack Akun like Postingan")
	emil_lope_usup(u+" ["+m+"08"+u+"]"+p+" Crack Akun Komen Postingan")
	emil_lope_usup(u+" ["+m+"o8"+u+"]"+p+" MODE "+m+"Target "+u+"("+k+"slow"+u+")")
	emil_lope_usup(u+" ["+m+"o9"+u+"]"+b+" RetaS Data Target")
	emil_lope_usup(u+" ["+m+"10"+u+"]"+p+" Cek Jumlah Hasil Crack")
	emil_lope_usup(u+" ["+m+"11"+u+"]"+p+" Ganti Tema "+u+"("+b+"New"+u+")")
	emil_lope_usup(u+" ["+m+"12"+u+"]"+p+" Cek Opsi Hasil Crack "+s+"("+h+"ok"+s+"/"+k+"cp"+s+")")
	emil_lope_usup(u+" ["+m+"13"+u+"]"+p+" Setting User Agent")
	emil_lope_usup(u+" ["+m+"14"+u+"]"+k+" Tentang Author")
